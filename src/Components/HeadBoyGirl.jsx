...
const HeadBoyGirl = () => {
  ...
  useEffect(() => {
    const fetchCandidates = async () => {
      try {
        ...
        setBoysCandidates(response.data.boys['Head Boy/Girl']);
        setGirlsCandidates(response.data.girls['Head Boy/Girl']);
      } catch (error) {
  ...
  return (
    <div className='flex flex-col items-center justify-center gap-10'>
      <h2 className='raleway-bold text-5xl section-heading text-animation'>Head Boy/Girl</h2>
      {!confirmation && (
        <>

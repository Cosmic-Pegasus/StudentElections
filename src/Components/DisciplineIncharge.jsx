...
const DisciplineIncharge = () => {
  ...
  useEffect(() => {
    const fetchCandidates = async () => {
      try {
        ...
        setBoysCandidates(response.data.boys['Discipline Incharge']);
        setGirlsCandidates(response.data.girls['Discipline Incharge']);
      } catch (error) {
  ...
  return (
    <div className='flex flex-col items-center justify-center gap-10'>
      <h2 className='raleway-bold text-5xl section-heading text-animation'>Discipline Incharge</h2>
      {!confirmation && (
        <>
...
export default DisciplineIncharge;
